...
`vfdlm-byte-bpe-v1.0.0` is the first approved tokenizer for the VoltForge Domain Language Model. It is a project-owned byte-level BPE implementation trained from scratch on the governed VFAI-009 task shards.
