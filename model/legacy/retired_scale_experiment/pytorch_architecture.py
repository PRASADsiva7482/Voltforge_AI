"""
Retired VoltForge scale-experiment PyTorch architecture.

Historical code only: no matching trained or release-approved checkpoint was
produced for this architecture.
