"""
Retired VoltForge scale-experiment NumPy architecture.

Historical code only: this was an allocation/architecture experiment, not a
trained or release-approved model.
